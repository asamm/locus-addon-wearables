...
import com.asamm.locus.addon.wear.gui.lists.ListItemAdapter;
import com.asamm.locus.addon.wear.gui.lists.ListItemLayout;
 ...
 */
public class TrackRecordActivityOld extends CustomActivityOld {

    // tag for logger
    private static final String TAG = "TrackRecordActivityOld";
