...
public class TrackRecordActivityConfiguration {
    ...
    public TrackRecStatTypeEnum getStatConfigAtPosition(int screenIdx, int cellIdx) {
    ...
    private CfgContainer createDefaultConfiguration() {
        ...
        mainScreenConfig.add(new TrackRecCellConfigDto((byte) 0, TrackRecStatTypeEnum.TOTAL_TIME));
        mainScreenConfig.add(new TrackRecCellConfigDto((byte) 1, TrackRecStatTypeEnum.TOTAL_LENGTH_MOVE));
        ...
        secondScreenConfig.add(new TrackRecCellConfigDto((byte) 0, TrackRecStatTypeEnum.SPEED));
        secondScreenConfig.add(new TrackRecCellConfigDto((byte) 1, TrackRecStatTypeEnum.SPEED_AVG_MOVE));
